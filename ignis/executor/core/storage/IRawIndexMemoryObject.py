...
from .iterator.IRawIndexMemoryIterator import readToWrite, IRawIndexMemoryReadIterator, IRawIndexMemoryWriteIterator
from ignis.data.IMemoryBuffer import IMemoryBuffer


class IRawIndexMemoryObject(IRawObject):
	TYPE = "rawIndexMemory"
	...
	def __readObservation(self):
		self._flush()
		obs = IRawIndexMemoryObject.__new__(IRawIndexMemoryObject)
